...
for each input value. It then stores the request in the result field of the 
given value and outputs it.
...
The \texttt{ResponseReader} is a component that for each input value
