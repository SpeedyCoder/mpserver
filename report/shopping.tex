...
\newpage
\begin{figure}[h]
\lstinputlisting[firstline=15,lastline=38]{../examples/shoppingServer/shoppingServer.go} 
...
\begin{figure}[h]
\lstinputlisting[firstline=40,lastline=74]{../examples/shoppingServer/shoppingServer.go} 
