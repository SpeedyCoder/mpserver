...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Appendices %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\section*{Appendix A - Example servers}
\addcontentsline{toc}{section}{Appendix A - Example servers}

\subsection*{Proxy Server Implementation}
\addcontentsline{toc}{subsection}{Proxy Server Implementation}
\subsubsection*{proxyServer.go}
\lstinputlisting{../examples/proxyServer/proxyServer.go}

\newpage
\subsection*{Shopping Server Implementation}
\addcontentsline{toc}{subsection}{Shopping Server Implementation}
